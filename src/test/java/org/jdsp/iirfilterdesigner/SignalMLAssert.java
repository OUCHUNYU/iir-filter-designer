...
public class SignalMLAssert extends Assert {
    ...
    /**
     * Asserts that two Complex numbers are equal concerning a delta equal to
     * 1e-5.
     *
     * @param expected the expected value
     * @param actual   the actual value
    ...
    /**
     * Asserts that the elements of two Complex number arrays are equal
     * concerning a delta.
     *
    ...
    /**
     * Asserts that the elements of two double arrays are equal concerning a
     * delta.
     *
     * @param expected the expected values
     * @param actual   the actual values
    ...
    /**
     * Asserts that the elements of two double matrices are equal concerning a
     * delta.
     *
     * @param expected the expected values
     * @param actual   the actual values
