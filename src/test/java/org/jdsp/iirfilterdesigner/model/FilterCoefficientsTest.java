...
public class FilterCoefficientsTest {
    ...
    public void testNormalize() throws BadFilterParametersException {
        ...
        FilterCoefficients coeffs = new FilterCoefficients(new double[]{0.1, 0.2, 0.3},
                new double[]{0.7, 0.5, 0.3});
        coeffs.normalize();
    ...
    /**
     * Test method for
     * {@link FilterCoefficients#transformLowpassToLowpass(double) }.
     */
    @Test
    public void testTransformLowpassToLowpass() throws BadFilterParametersException {

        double[] b = new double[]{0.06264858};
        double[] a = new double[]{1.00000000, 0.57450003, 1.41502514, 0.54893711, 0.40796631, 0.06264858};
        FilterCoefficients coeffs = new FilterCoefficients(b, a);

        double[] pythonB = new double[]{47573.76605485};
        double[] pythonA = new double[]{1.00000000e+00, 8.61750040e+00, 3.18380657e+02, 1.85266276e+03,
                2.06532946e+04, 4.75737661e+04};
    ...
    /**
     * Test method for
     * {@link FilterCoefficients#transformLowpassToHighpass(double) }.
     */
    @Test
    public void testTransformLowpassToHighpass() throws BadFilterParametersException {
        ...
        double[] pythonA = new double[]{1.00000000e+00, 1.95359404e+01, 7.88594723e+01, 6.09841090e+02,
                7.42786214e+02, 3.87877901e+03};
    ...
    /**
     * Test method for
     * {@link FilterCoefficients#transformLowpassToBandpass(double, double) }.
     */
    @Test
    public void testTransformLowpassToBandpass() throws BadFilterParametersException {
        ...
        double[] pythonA = new double[]{1.00000000e+00, 1.14900006e+00, 5.06601006e+01, 4.57554990e+01,
                9.69350176e+02, 6.39465728e+02, 8.72415158e+03, 3.70619542e+03, 3.69312133e+04, 7.53858939e+03,
                5.90490000e+04};
    ...
    /**
     * Test method for
     * {@link FilterCoefficients#transformFromLowpassToBandstop(double, double) }.
     */
    @Test
    public void testTransformLowpassToBandstop() throws BadFilterParametersException {
        ...
        double[] pythonB = new double[]{1.00000000e+00, 0.00000000e+00, 4.50000000e+01, 0.00000000e+00,
                8.10000000e+02, 0.00000000e+00, 7.29000000e+03, 0.00000000e+00, 3.28050000e+04, 0.00000000e+00,
                5.90490000e+04};
        double[] pythonA = new double[]{1.00000000e+00, 1.30239603e+01, 8.00486546e+01, 6.49556230e+02,
                1.90303688e+03, 1.00929163e+04, 1.71273319e+04, 5.26140546e+04, 5.83554692e+04, 8.54502037e+04,
                5.90490000e+04};
    ...
    /**
     * Test method for cooperation between
     * {@link FilterCoefficients#transformFromLowpassToBandstop(double, double)
    ...
    public void testBilinearTransform() throws BadFilterParametersException {
        ...
        pythonB = new double[]{0.04959992, -0.04839636, -0.04957248, 0.0484238};
        pythonA = new double[]{1., -2.95959636, 2.92041588, -0.96078816};
