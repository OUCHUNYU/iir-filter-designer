...
import static org.jdsp.iirfilterdesigner.SignalMLAssert.assertEquals;
...
public class TransferFunctionTest {
    ...
    public void testCalculateTransferFunction() {
        ...
        Complex[] expectedGain = new Complex[]{new Complex(0.20666667, 0), new Complex(0.20659255, -0.00140395),
