...
public class Chebyshev2IIRDesignerTest {
    ...
    /**
     * an instance of {@link Chebyshev2IIRDesigner} needed to all the tested
     * methods
     */
    ...
    /**
     * Test method for
     * {@link Chebyshev2IIRDesigner#calculatePrototype(int, double) }.
     */
    @Test
    public void testCalculateChebyshev2Prototype() {
        ...
        Complex[] poles = new Complex[]{new Complex(-0.17737632, -1.07757832),
                new Complex(-3.36188451, -1.44406328e-15), new Complex(-0.17737632, 1.07757832)};
    ...
    /**
     * Test method for
     * {@link Chebyshev2IIRDesigner#designDigitalFilter(org.signalml.math.iirdesigner.FilterType, double[], double[], double, double) }.
     */
    @Test
    public void testDesignDigitalFilter() throws BadFilterParametersException {
        ...
        FilterCoefficients coeffs = iirdesigner.designFilter(FilterType.LOWPASS, new double[]{0.1},
        ...
        coeffs = iirdesigner.designDigitalFilter(FilterType.HIGHPASS, new double[]{0.7}, new double[]{0.2}, 3.0,
                40.0);
        assertEquals(new FilterCoefficients(pythonB, pythonA), coeffs, 1e-8);

        // bandpass
        pythonB = new double[]{3.49030352e-02, 1.99241721e-02, -3.69150532e-02, -4.45893421e-18, 3.69150532e-02,
                -1.99241721e-02, -3.49030352e-02};
        pythonA = new double[]{1.0, 1.53977953, 2.54604688, 2.03168879, 1.68294636, 0.64377119, 0.27144655};
        ...
        // bandstop
        pythonB = new double[]{0.16237092, 0.2964514, 0.61138715, 0.59303041, 0.61138715, 0.2964514, 0.16237092};
        pythonA = new double[]{1.0, 0.91835019, 0.14443493, 0.16130349, 0.41398049, 0.10627954, -0.0108993};
    ...
    /**
     * Test method for
     * {@link Chebyshev2IIRDesigner#calculateNaturalFrequency(org.signalml.math.iirdesigner.FilterType, int, double[], double[], double, double, boolean) }.
     */
    @Test
    public void testCalculateNaturalFrequency() throws BadFilterParametersException {
        ...
        // digital bandstop
        wna = iirdesigner.calculateNaturalFrequency(FilterType.BANDSTOP, 11, new double[]{0.5, 0.7},
                new double[]{0.55, 0.65}, 0.5, 100, true);
        assertEquals(new double[]{0.54813224, 0.6522109}, wna, 1e-4);

        // digital bandpass
        wna = iirdesigner.calculateNaturalFrequency(FilterType.BANDPASS, 10, new double[]{0.6, 0.7},
