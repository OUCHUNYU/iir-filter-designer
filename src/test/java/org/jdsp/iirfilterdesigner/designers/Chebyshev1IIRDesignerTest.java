...
public class Chebyshev1IIRDesignerTest {
    ...
    /**
     * Test method for
     * {@link Chebyshev1IIRDesigner#calculatePrototype(int, double) }.
     */
    @Test
    public void testCalculateChebyshev1Prototype() {
        ...
        Complex[] poles = new Complex[]{new Complex(-0.14931010, 9.03814429e-01),
                new Complex(-0.29862021, 6.39042136e-17), new Complex(-0.14931010, -9.03814429e-01)};
    ...
    /**
     * Test method for
     * {@link Chebyshev1IIRDesigner#designDigitalFilter(org.signalml.math.iirdesigner.FilterType, double[], double[], double, double) }.
     */
    @Test
    public void testDesignDigitalFilter() throws BadFilterParametersException {
        ...
        // lowpass test
        pythonB = new double[]{7.02019760e-05, 2.80807904e-04, 4.21211856e-04, 2.80807904e-04, 7.02019760e-05};
        pythonA = new double[]{1.0, -3.72214229, 5.29043743, -3.39981985, 0.83311132};
        coeffs = iirdesigner.designDigitalFilter(FilterType.LOWPASS, new double[]{0.1}, new double[]{0.2}, 3.0,
                40.0);
        ...
        coeffs = iirdesigner.designDigitalFilter(FilterType.HIGHPASS, new double[]{0.7}, new double[]{0.2}, 5.0,
                10.0);
    ...
    /**
     * Test method for
     * {@link Chebyshev1IIRDesigner#calculateNaturalFrequency(org.signalml.math.iirdesigner.FilterType, int, double[], double[], double, double, boolean) }.
     */
    @Test
    public void testCalculateNaturalFrequency() {

        double[] wn = iirdesigner.calculateNaturalFrequency(FilterType.BANDPASS, 10, new double[]{0.6, 0.7},
                new double[]{0.55, 0.8}, 0.5, 100, true);
        assertEquals(new double[]{0.6, 0.7}, wn, 1e-16);

        wn = iirdesigner.calculateNaturalFrequency(FilterType.BANDPASS, 10, new double[]{0.6, 0.7},
                new double[]{0.55, 0.8}, 0.5, 100, false);
        assertEquals(new double[]{0.6, 0.7}, wn, 1e-16);
    ...
    /**
     * Test method for
     * {@link Chebyshev1IIRDesigner#calculateFilterOrder(org.signalml.math.iirdesigner.FilterType, double[], double[], double, double, boolean) }.
     */
    @Test
