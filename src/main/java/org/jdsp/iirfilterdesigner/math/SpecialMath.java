...
public class SpecialMath {
    ...
    /**
     * the machine epsilon for the type double - the largest positive value
     * that, when added to 1.0, produces a sum equal to 1.0.
     */
    static double machineEpsilon;

    /**
     * Returns the value of the machine epsilon for the type double - i.e. the
     * largest positive value that, when added to 1.0, produces a sum equal to
     * 1.0.
     *
     ...
     *
     * @param m the value of an m argument at which the integral will be
     *          calculated
    ...
    public static double calculateCompleteEllipticIntegralOfTheFirstKind(double m) {
        ...
        double P[] = {1.37982864606273237150E-4, 2.28025724005875567385E-3, 7.97404013220415179367E-3,
        ...
        double Q[] = {2.94078955048598507511E-5, 9.14184723865917226571E-4, 5.94058303753167793257E-3,
     ...
     * of parameter m between 0 and 1, and real argument u. (based on the
     * function from the Cephes Math Library)
     *
     * @param u
     * @param m
    ...
    /**
     * Compute the inverse hyperbolic cosine of a number. * (Note: This method
     * is copy-pasted from apache.commons.math.util.FastMath under Apache
     * License v2.0. After releasing version 3.0 of commons.math library this
     * code should be deleted and all calls to this method should substituted by
     * calls to apache.commons.math.util.FastMath equivalent method).
     *
    ...
    /**
     * Compute the inverse hyperbolic sine of a number. (Note: This method is
     * copy-pasted from apache.commons.math.util.FastMath under Apache License
     * v2.0. After releasing version 3.0 of commons.math library this code
     * should be deleted and all calls to this method should substituted by
     * calls to apache.commons.math.util.FastMath equivalent method).
     *
     * @param a number on which evaluation is done
    ...
    public static double asinh(double a) {
        ...
        if (a > 0.167) {
            ...
            if (a > 0.097) {
                ...
                absAsinh = a * (1 - a2 * (1 / 3.0 - a2 * (1 / 5.0 - a2 * (1 / 7.0
                        - a2 * (1 / 9.0 - a2 * (1.0 / 11.0 - a2 * (1.0 / 13.0) * 11.0 / 12.0) * 9.0 / 10.0) * 7.0 / 8.0)
                        * 5.0 / 6.0) * 3.0 / 4.0) / 2.0);
            } else if (a > 0.0036) {
                absAsinh = a * (1 - a2
                        * (1 / 3.0
                        - a2 * (1 / 5.0 - a2 * (1 / 7.0 - a2 * (1 / 9.0) * 7.0 / 8.0) * 5.0 / 6.0) * 3.0 / 4.0)
                        / 2.0);
            } else {
