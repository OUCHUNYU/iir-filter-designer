...
public class ComplexPolynomial {
    ...
    /**
     * Coefficients of the polynomial. The first (zero) element is the
     * coefficient beside the highest exponent.
     */
     ...
     *                     (coefficients[0]) element should be the coefficient beside the
     *                     highest exponent.
     */
