...
public class FunctionOptimizer {
     ...
     * @param nmax     the maximum number of iterations allowed by the simplex
     *                 procedure
     * @return the value of the parameter at which the value of the function is
     * minimum
     */
    public static double minimizeFunction(UnivariateRealFunction function, double start, int nmax) {
        UnivariateFunctionWrappedInAMultivariate wrappedFunction = new UnivariateFunctionWrappedInAMultivariate(
                function);
     ...
     *                     procedure
     * @return the value of the parameter at which the value of the function is
     * minimum (at the given constraints).
     */
    public static double minimizeFunctionConstrained(UnivariateRealFunction function, double lowerBounds,
                                                     double higherBounds, int nmax) {
