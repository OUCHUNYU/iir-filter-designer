...
public class FilterCoefficients {
    ...
    /**
     * Returs the order of the filter represented by the feedback and
     * feedforward coefficients stored in the {@link FilterCoefficients}
     *
    ...
    /**
     * Returs whether the order of the filter represented by the coefficients
     * stored in the {@link FilterCoefficients} is odd.
     *
     ...
     * this function transforms it to a lowpass filter with a given cutoff
     * frequency.
     *
    ...
    /**
     * If the the filter represented by the coefficients is a lowpass prototype,
     * this function transforms it to a highpass filter with a given cutoff
     * frequency.
     *
     * @param w0 the cutoff frequency
     */
    ...
    /**
     * If the filter represented by the coefficients is an analog filter, this
