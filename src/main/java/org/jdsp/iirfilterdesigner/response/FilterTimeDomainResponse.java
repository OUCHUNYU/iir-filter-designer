...
/**
 * This class can hold a representation of various filter time domain responses
...
public class FilterTimeDomainResponse {
    ...
    /**
     * If a filter time response has values above this threshold, the filter is
     * considered to be instable.
     */
