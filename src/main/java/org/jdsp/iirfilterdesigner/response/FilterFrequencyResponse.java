...
public class FilterFrequencyResponse {
    ...
    /**
     * Returns an array containing the frequencies at which this frequency
    ...
    /**
     * Sets the frequencies for this frequency response. The new frequency array
     * size must be equal to the number of points given to the constructor.
     *
     * @param frequencies the new frequencies values for this frequency response
     */
    public void setFrequencies(double[] frequencies) {
        /*
         * the number of points was set in the constructor should not change.
         */
    ...
    /**
     * Sets the value of the specified elements in the frequency and gain
     * arrays.
     *
     * @param i         the index of the element to change
