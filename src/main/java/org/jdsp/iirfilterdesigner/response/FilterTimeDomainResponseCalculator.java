...
public class FilterTimeDomainResponseCalculator extends FilterResponseCalculator {
    ...
    // */
    // public FilterTimeDomainResponseCalculator(double samplingFrequency,
    ...
    // double[] stepResponseAmplitudes =
    // AbstractIIRSinglechannelSampleFilter.filter(filterCoefficients.getBCoefficients(),
    // filterCoefficients.getACoefficients(), excitation);
    //
    // return new FilterTimeDomainResponse(stepResponseAmplitudes,
    // samplingFrequency);
    // }
    //
    // /**
    ...
    // double[] impulseResponseAmplitudes =
    // AbstractIIRSinglechannelSampleFilter.filter(filterCoefficients.getBCoefficients(),
    // filterCoefficients.getACoefficients(), excitation);
    //
    // FilterTimeDomainResponse stepResponse = new
    // FilterTimeDomainResponse(impulseResponseAmplitudes, samplingFrequency);
    // return stepResponse;
    // }
