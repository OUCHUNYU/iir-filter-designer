...
import org.jdsp.iirfilterdesigner.fft.FourierTransform;
...
import org.jdsp.iirfilterdesigner.model.TransferFunction;
...
public class FilterFrequencyResponseCalculator extends FilterResponseCalculator {
    ...
    /**
     * The number of points the filter responses calculated using this
     * FilterResponseCalculator would have.
     */
    ...
    /**
     * The frequencies vector for frequency responses calculated using this
     * FilterResponseCalculator.
     */
    ...
    /**
     * Returns the magnitude of the frequency response of the filter set in the
     * constructor.
     *
