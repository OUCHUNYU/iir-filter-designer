...
public class WindowFunction {
    ...
    /**
     * the calculated weights of the window function; the signal is multiplied
     * by these weights to obtain windowed data
     */
     ...
     * of these values is different then formerly invalidates calculated
     * weights.
     *
    ...
    /**
     * Applies the window to the real data and returns the array with windowed
     * data.
     * <p>
     * The array with windowed data is twice as large as the original data
     * because the (real) values are stored only in cells with even indexes (odd
     * indexes are reserved for imaginary values).
     *
