...
import org.jdsp.iirfilterdesigner.math.SpecialMath;
...
public class EllipticIIRDesigner extends AbstractIIRDesigner {
    ...
    /**
     * Returns zeros, poles, and gain of an normalized prototype analog lowpass
     * Elliptic filter which meets the specification.
     *
     ...
     */
    @Override
    protected FilterZerosPolesGain calculatePrototype(int filterOrder, double gpass, double stopbandRipple)
     ...
     * @param filterOrder the order of the filter to be designed (can be
     *                    calculated using
     *                    {@link AbstractIIRDesigner#calculateFilterOrder(org.jdsp.iirfilterdesigner.model.FilterType, double[], double[], double, double, boolean) })
